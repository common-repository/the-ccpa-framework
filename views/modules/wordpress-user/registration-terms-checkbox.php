<p class="ccpa-terms-container" style="margin-bottom: 10px">
<?php
...
?>
	<label>
		...
		<?php else : ?>
			...
			?>
		<?php endif; if( get_option( 'ccpa_consent_until_display' ) === '1' ){ ?>* for<?php } ?>

</label>
<?php if( get_option( 'ccpa_consent_until_display' ) === '1' ){ ?>
<span class="ccpa-consent-until-wrap">
		<span class="dashicons dashicons-calendar-alt ccpa-consent-until-cal"></span>
