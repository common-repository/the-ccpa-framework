...
<p class="ccpa-disclaimer">
	...
	Using The CCPA Framework does NOT guarantee compliance to CCPA.
	...
	Data443 is not eligible for any claim or action based on any information or functionality provided by this plugin.
	...
	For compliance audit or further help contact legal professionals.
	As each business and situation is unique, you might need to modify, add or delete information in these templates.
	In addition to this, you will need to audit all your processing activities for achieving compliance to CCPA.
	Compliance to CCPA is risk based ongoing process.
	We are here to get you started.
</p>
<hr>
<input type="submit" class="button button-ccpa button-large button-ccpa-large button-center" value="<?php echo _x( 'I accept', '(Admin)', 'ccpa-framework' ); ?>" />
